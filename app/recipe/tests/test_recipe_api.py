...
class PrivateRecipeAPITests(TestCase):
    ...
    # _______________filtering________________#

    def test_filter_by_tags(self):
        """Test filtering recipe by tags. """
        r1 = create_recipe(user=self.user, title='Masala Dosa')
        r2 = create_recipe(user=self.user, title='Greek Salad')
        tag1 = Tag.objects.create(user=self.user, name='Non-Vegiterian')
        tag2 = Tag.objects.create(user=self.user, name='Vegiterian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Dal Bhat')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Dumplings')
        r2 = create_recipe(user=self.user, title='Pulawo')
        ...
        r3 = create_recipe(user=self.user, title='Japanese Soba Noodles')
        ...
        # _______________________image test_________________________
...
class ImageUploadTests(TestCase):
    ...
    def tearDown(self):
        """ to remove images from the directory after the test completion"""
